...
const StepperComponent = ({
   ...
   * 
   * @param step - step index, to check if current step is completed, 
   * if yes, can click on the step navigation and navigate to the step
   */
  ...
  // If click on the signIn step, set current form Id to empty, 
  // and clear all form states (reset the form)
  const handleSignIn = () => {
    if (setCurrentFormId) {
      setCurrentFormId("");
    }
